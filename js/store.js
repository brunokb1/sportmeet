...
const FRIEND_EVENTS = {
  'fr-1': [
    { id:'fev-b1', title:'Futsal Semanal',    sport:'⚽', sportSlug:'futebol',  gradient:'linear-gradient(135deg,#22C55E,#15803D)', ageRange:'20-30 anos', datetime:'2026-04-27T20:00', duration:'1h',    local:'Campo Society Lapa',    address:'Rua Cerro Corá, 900',     region:'Lapa',    period:'noite', createdBy:'Bruno',  creatorInitial:'B', creatorColor:'av-purple', description:'Pelada semanal de futsal. Todos bem-vindos!',             maxParticipants:14, participants:[{i:'B',c:'av-purple',name:'Bruno'},{i:'L',c:'av-green',name:'Lucas'},{i:'P',c:'av-teal',name:'Pedro'}], isOpen:true, status:'active', source:'created' },
    { id:'fev-b2', title:'Corrida no Povo',   sport:'🏃', sportSlug:'corrida',  gradient:'linear-gradient(135deg,#22C55E,#059669)', ageRange:'Todos',      datetime:'2026-04-28T07:00', duration:'45min', local:'Parque do Povo',        address:'Av. Brig. Faria Lima, s/n',region:'Itaim', period:'manhã', createdBy:'Bruno',  creatorInitial:'B', creatorColor:'av-purple', description:'Corrida leve às margens do parque. 3 km.',                maxParticipants:10, participants:[{i:'B',c:'av-purple',name:'Bruno'},{i:'A',c:'av-pink',name:'Alice'}], isOpen:true, status:'active', source:'created' },
  ],
  'fr-2': [
    { id:'fev-a1', title:'Corrida Feminina',  sport:'🏃', sportSlug:'corrida',  gradient:'linear-gradient(135deg,#EC4899,#BE185D)', ageRange:'Mulheres',   datetime:'2026-04-26T08:00', duration:'1h',    local:'Parque Ibirapuera',     address:'Portão 5, Parque Ibirapuera',region:'Moema',period:'manhã', createdBy:'Alice',  creatorInitial:'A', creatorColor:'av-pink',   description:'Corrida para mulheres de todos os níveis. Ritmo livre!', maxParticipants:15, participants:[{i:'A',c:'av-pink',name:'Alice'},{i:'M',c:'av-blue',name:'Marina'},{i:'C',c:'av-orange',name:'Camila'}], isOpen:true, status:'active', source:'created' },
    { id:'fev-a2', title:'5K Paulista',       sport:'🏃', sportSlug:'corrida',  gradient:'linear-gradient(135deg,#3B82F6,#1D4ED8)', ageRange:'18-40 anos', datetime:'2026-05-03T07:30', duration:'1h',    local:'Av. Paulista — MASP',   address:'Av. Paulista, 1578',  region:'Centro',  period:'manhã', createdBy:'Alice',  creatorInitial:'A', creatorColor:'av-pink',   description:'Corrida no domingo de manhã pela Paulista fechada.',      maxParticipants:30, participants:[{i:'A',c:'av-pink',name:'Alice'}], isOpen:true, status:'active', source:'created' },
  ],
  'fr-3': [
    { id:'fev-c1', title:'Pedalada Parque',   sport:'🚴', sportSlug:'ciclismo', gradient:'linear-gradient(135deg,#3B82F6,#1D4ED8)', ageRange:'18-40 anos', datetime:'2026-04-26T08:00', duration:'2h',    local:'Parque Villa-Lobos',    address:'Av. Prof. Fonseca Rod., 2001',region:'Lapa',period:'manhã', createdBy:'Carlos', creatorInitial:'C', creatorColor:'av-teal',   description:'Pedalada em grupo de 20 km. Ritmo moderado.',             maxParticipants:20, participants:[{i:'C',c:'av-teal',name:'Carlos'},{i:'B',c:'av-purple',name:'Bruno'}], isOpen:true, status:'active', source:'created' },
  ],
  'fr-4': [
    { id:'fev-cam1', title:'Yoga Sunset',     sport:'🧘', sportSlug:'yoga',     gradient:'linear-gradient(135deg,#EC4899,#BE185D)', ageRange:'Todos',      datetime:'2026-04-28T18:30', duration:'1h',    local:'Parque Ibirapuera',     address:'Portão 3, Parque Ibirapuera',region:'Moema',period:'noite', createdBy:'Camila', creatorInitial:'C', creatorColor:'av-orange', description:'Yoga ao pôr do sol. Traga seu tapete!',                   maxParticipants:15, participants:[{i:'C',c:'av-orange',name:'Camila'},{i:'A',c:'av-pink',name:'Alice'},{i:'M',c:'av-blue',name:'Marina'}], isOpen:true, status:'active', source:'created' },
    { id:'fev-cam2', title:'Meditação Manhã', sport:'🧘', sportSlug:'yoga',     gradient:'linear-gradient(135deg,#8B5CF6,#6D28D9)', ageRange:'Todos',      datetime:'2026-05-01T07:00', duration:'45min', local:'Parque Trianon',        address:'Av. Paulista, 1351',  region:'Centro',  period:'manhã', createdBy:'Camila', creatorInitial:'C', creatorColor:'av-orange', description:'Meditação guiada no parque. Paz e equilíbrio.',           maxParticipants:10, participants:[{i:'C',c:'av-orange',name:'Camila'}], isOpen:true, status:'active', source:'created' },
  ],
  'fr-5': [
    { id:'fev-l1', title:'Futebol Brooklin',  sport:'⚽', sportSlug:'futebol',  gradient:'linear-gradient(135deg,#22C55E,#166534)', ageRange:'20-30 anos', datetime:'2026-04-30T19:00', duration:'1h30',  local:'Arena Society Brooklin',address:'Rua Álvaro Cruz, 300',  region:'Brooklin',period:'noite', createdBy:'Lucas',  creatorInitial:'L', creatorColor:'av-green',  description:'Racha semanal society. Times de 7.',                      maxParticipants:14, participants:[{i:'L',c:'av-green',name:'Lucas'},{i:'B',c:'av-purple',name:'Bruno'},{i:'G',c:'av-teal',name:'Gabriel'},{i:'R',c:'av-blue',name:'Rodrigo'}], isOpen:true, status:'active', source:'created' },
    { id:'fev-l2', title:'Fut7 Fim de Sem.', sport:'⚽', sportSlug:'futebol',  gradient:'linear-gradient(135deg,#22C55E,#15803D)', ageRange:'18-35 anos', datetime:'2026-05-02T10:00', duration:'2h',    local:'Campo Society Lapa',    address:'Rua Cerro Corá, 900',   region:'Lapa',    period:'manhã', createdBy:'Lucas',  creatorInitial:'L', creatorColor:'av-green',  description:'Futebol de 7 no fim de semana. Vagas abertas.',           maxParticipants:14, participants:[{i:'L',c:'av-green',name:'Lucas'}], isOpen:true, status:'active', source:'created' },
  ],
  'fr-6': [
    { id:'fev-m1', title:'Natação Livre',     sport:'🏊', sportSlug:'natação',  gradient:'linear-gradient(135deg,#06B6D4,#0E7490)', ageRange:'18-40 anos', datetime:'2026-04-29T07:00', duration:'1h',    local:'SESC Pompéia',          address:'Rua Clélia, 93',        region:'Lapa',    period:'manhã', createdBy:'Marina', creatorInitial:'M', creatorColor:'av-blue',   description:'Raia livre. Traga touca e óculos de natação.',            maxParticipants:20, participants:[{i:'M',c:'av-blue',name:'Marina'},{i:'A',c:'av-pink',name:'Alice'}], isOpen:true, status:'active', source:'created' },
  ],
};

/* ── pools de dados estáticos ────────────────────────────── */
const FEED_POOL = [
  { id:'fd-1',  title:'Corrida no Parque',     sport:'🏃', sportSlug:'corrida',   gradient:'linear-gradient(135deg,#22C55E,#15803D)', ageRange:'20-30 anos', datetime:'2026-04-25T07:00', duration:'1h',    local:'Parque Ibirapuera',           address:'Portão 5, Parque Ibirapuera',     region:'Moema',   period:'manhã', createdBy:'Pedro',   creatorInitial:'P', creatorColor:'av-orange', description:'Corrida em grupo, ritmo confortável. Todos os níveis!',                               maxParticipants:20, participants:[{i:'P',c:'av-orange',name:'Pedro'}], isOpen:true },
  { id:'fd-2',  title:'Tênis no Clube',         sport:'🎾', sportSlug:'tênis',     gradient:'linear-gradient(135deg,#F97316,#C2410C)', ageRange:'25-35 anos', datetime:'2026-04-28T19:30', duration:'1h30',  local:'Clube Esportivo Pinheiros',    address:'Rua Gomes de Carvalho, 500',      region:'Itaim',   period:'noite', createdBy:'Ana',     creatorInitial:'A', creatorColor:'av-pink',   description:'Jogo de duplas. Nível intermediário. Raquetes disponíveis.',                          maxParticipants:4,  participants:[{i:'A',c:'av-pink',name:'Alice'},{i:'R',c:'av-blue',name:'Rodrigo'}], isOpen:true },
  { id:'fd-3',  title:'Basquete 3×3',           sport:'🏀', sportSlug:'basquete',  gradient:'linear-gradient(135deg,#8B5CF6,#6D28D9)', ageRange:'18-30 anos', datetime:'2026-04-29T18:00', duration:'2h',    local:'Quadra Brooklin',              address:'Av. Morumbi, 123',                region:'Brooklin',period:'noite', createdBy:'Lucas',   creatorInitial:'L', creatorColor:'av-green',  description:'Racha animado 3×3. Galera boa e sem frescura.',                                       maxParticipants:12, participants:[{i:'L',c:'av-green',name:'Lucas'},{i:'G',c:'av-teal',name:'Gabriel'},{i:'M',c:'av-blue',name:'Marina'}], isOpen:true },
  { id:'fd-4',  title:'Natação Livre',           sport:'🏊', sportSlug:'natação',   gradient:'linear-gradient(135deg,#06B6D4,#0E7490)', ageRange:'Todos',      datetime:'2026-05-01T06:30', duration:'1h',    local:'SESC Pompéia',                 address:'Rua Clélia, 93, Pompéia',         region:'Lapa',    period:'manhã', createdBy:'Camila',  creatorInitial:'C', creatorColor:'av-teal',   description:'Raia livre aberta. Traga touca e óculos de natação.',                                 maxParticipants:30, participants:[{i:'C',c:'av-teal',name:'Carlos'}], isOpen:true },
  { id:'fd-5',  title:'Vôlei na Praia',          sport:'🏐', sportSlug:'vôlei',     gradient:'linear-gradient(135deg,#EAB308,#B45309)', ageRange:'Aberto',     datetime:'2026-04-26T09:00', duration:'2h',    local:'Parque Villa-Lobos',           address:'Av. Prof. Fonseca Rodrigues, 2001',region:'Lapa',   period:'manhã', createdBy:'Rafael',  creatorInitial:'R', creatorColor:'av-yellow', description:'Pelada de vôlei de areia. 6×6! Vaga aberta.',                                         maxParticipants:12, participants:[{i:'R',c:'av-yellow',name:'Rafael'},{i:'B',c:'av-blue',name:'Beatriz'},{i:'F',c:'av-green',name:'Felipe'}], isOpen:true },
  { id:'fd-6',  title:'Ciclismo Urbano',          sport:'🚴', sportSlug:'ciclismo',  gradient:'linear-gradient(135deg,#3B82F6,#1D4ED8)', ageRange:'18-40 anos', datetime:'2026-04-26T08:00', duration:'2h',    local:'Av. Paulista — MASP',          address:'Av. Paulista, 1578',              region:'Centro',  period:'manhã', createdBy:'Felipe',  creatorInitial:'F', creatorColor:'av-blue',   description:'Pedalada urbana de 20 km. Ritmo moderado. Capacete obrigatório.',                     maxParticipants:25, participants:[{i:'F',c:'av-blue',name:'Felipe'},{i:'J',c:'av-teal',name:'Joao'}], isOpen:true },
  { id:'fd-7',  title:'Yoga ao Ar Livre',         sport:'🧘', sportSlug:'yoga',      gradient:'linear-gradient(135deg,#EC4899,#BE185D)', ageRange:'Todos',      datetime:'2026-04-27T07:30', duration:'1h',    local:'Parque Villa-Lobos',           address:'Av. Prof. Fonseca Rodrigues, 2001',region:'Lapa',   period:'manhã', createdBy:'Sofia',   creatorInitial:'S', creatorColor:'av-pink',   description:'Yoga para todos os níveis em contato com a natureza. Traga seu tapete.',              maxParticipants:20, participants:[{i:'S',c:'av-pink',name:'Sofia'},{i:'L',c:'av-orange',name:'Luana'}], isOpen:true },
  { id:'fd-8',  title:'Futebol Society',           sport:'⚽', sportSlug:'futebol',   gradient:'linear-gradient(135deg,#22C55E,#166534)', ageRange:'20-35 anos', datetime:'2026-04-26T20:00', duration:'1h30',  local:'Arena Society Brooklin',       address:'Rua Álvaro Cruz, 300',            region:'Brooklin',period:'noite', createdBy:'Marcos',  creatorInitial:'M', creatorColor:'av-green',  description:'Pelada society. Times de 7 jogadores. Chuteira obrigatória.',                         maxParticipants:14, participants:[{i:'M',c:'av-green',name:'Marcos'},{i:'D',c:'av-blue',name:'Diego'},{i:'R',c:'av-purple',name:'Rafael'}], isOpen:true },
  { id:'fd-9',  title:'Escalada Indoor',           sport:'🧗', sportSlug:'escalada',  gradient:'linear-gradient(135deg,#6B7280,#374151)', ageRange:'Todos',      datetime:'2026-05-02T15:00', duration:'2h',    local:'Boulder Brasil Morumbi',       address:'Av. Giovanni Gronchi, 5750',      region:'Morumbi', period:'tarde', createdBy:'Thiago',  creatorInitial:'T', creatorColor:'av-purple', description:'Escalada em bloco para todos os níveis. Sapatos para aluguel.',                        maxParticipants:10, participants:[{i:'T',c:'av-purple',name:'Thiago'}], isOpen:true },
  { id:'fd-10', title:'Capoeira no Parque',        sport:'🥋', sportSlug:'capoeira',  gradient:'linear-gradient(135deg,#F59E0B,#B45309)', ageRange:'18-45 anos', datetime:'2026-04-30T19:00', duration:'1h30',  local:'Centro Cultural SP',           address:'Rua Vergueiro, 1000',             region:'Paraíso', period:'noite', createdBy:'Luiz',    creatorInitial:'L', creatorColor:'av-orange', description:'Roda aberta de capoeira. Berimbau, atabaque e muita energia!',                         maxParticipants:30, participants:[{i:'L',c:'av-orange',name:'Luana'},{i:'P',c:'av-green',name:'Paulo'}], isOpen:true },
  { id:'fd-11', title:'Corrida de Montanha',       sport:'🏔️',sportSlug:'corrida',   gradient:'linear-gradient(135deg,#059669,#065F46)', ageRange:'20-40 anos', datetime:'2026-05-03T06:00', duration:'3h',    local:'Pico do Jaraguá',              address:'Estrada do Jaraguá, km 5',        region:'Jaraguá', period:'manhã', createdBy:'André',   creatorInitial:'A', creatorColor:'av-green',  description:'Trail running no Jaraguá. Nível intermediário. Traga hidratação.',                    maxParticipants:15, participants:[{i:'A',c:'av-green',name:'Andre'}], isOpen:true },
  { id:'fd-12', title:'Handebol Recreativo',       sport:'🤾', sportSlug:'handebol',  gradient:'linear-gradient(135deg,#DC2626,#991B1B)', ageRange:'18-35 anos', datetime:'2026-05-02T10:00', duration:'1h30',  local:'Ginásio da Aclimação',         address:'Parque da Aclimação, Portão 1',   region:'Aclimação',period:'manhã', createdBy:'Bruna',  creatorInitial:'B', creatorColor:'av-red',    description:'Jogo recreativo de handebol. Sem experiência necessária.',                             maxParticipants:14, participants:[{i:'B',c:'av-red',name:'Bruna'}], isOpen:true },
];

const SEARCH_POOL = [
  { id:'sr-1', title:'Futebol com o Bruno',   sport:'⚽', sportSlug:'futebol',  gradient:'linear-gradient(135deg,#22C55E,#15803D)', ageRange:'20-30 anos', datetime:'2026-04-26T19:00', duration:'1h',    local:'Quadra Coberta Brooklin',  address:'Rua Barão do Trinfo, 121',       region:'Brooklin', period:'noite', createdBy:'Bruno',   creatorInitial:'B', creatorColor:'av-purple', description:'Jogo casual de futsal. Levar chuteira e calção.',               maxParticipants:20, participants:[{i:'B',c:'av-purple',name:'Bruno'},{i:'A',c:'av-pink',name:'Alice'},{i:'P',c:'av-orange',name:'Pedro'},{i:'J',c:'av-teal',name:'Joao'},{i:'M',c:'av-blue',name:'Marina'}], isOpen:true },
  { id:'sr-2', title:'Corrida Matinal',        sport:'🏃', sportSlug:'corrida',  gradient:'linear-gradient(135deg,#22C55E,#15803D)', ageRange:'20-35 anos', datetime:'2026-04-27T06:30', duration:'1h',    local:'Parque Ibirapuera',        address:'Portão 5, Parque Ibirapuera',    region:'Moema',    period:'manhã', createdBy:'Maria',   creatorInitial:'M', creatorColor:'av-purple', description:'Corrida leve de 5 km ao redor do parque. Ritmo 6:30/km.',     maxParticipants:15, participants:[{i:'M',c:'av-purple',name:'Maria'},{i:'C',c:'av-teal',name:'Carlos'}], isOpen:true },
  { id:'sr-3', title:'Basquete Tarde',         sport:'🏀', sportSlug:'basquete', gradient:'linear-gradient(135deg,#8B5CF6,#6D28D9)', ageRange:'18-30 anos', datetime:'2026-04-29T16:00', duration:'2h',    local:'Quadra Moema',             address:'Av. Moaci, 300',                 region:'Moema',    period:'tarde', createdBy:'Carlos',  creatorInitial:'C', creatorColor:'av-blue',   description:'Racha de basquete, galera boa e animada.',                    maxParticipants:10, participants:[{i:'C',c:'av-blue',name:'Carlos'},{i:'G',c:'av-green',name:'Gabriel'}], isOpen:true },
  { id:'sr-4', title:'Tênis Iniciante',        sport:'🎾', sportSlug:'tênis',    gradient:'linear-gradient(135deg,#F97316,#C2410C)', ageRange:'20-40 anos', datetime:'2026-04-28T08:00', duration:'1h30',  local:'Clube Lapa',               address:'Rua Ministro Godoi, 1000',       region:'Lapa',     period:'manhã', createdBy:'Ana',     creatorInitial:'A', creatorColor:'av-pink',   description:'Aula aberta para iniciantes no tênis. Raquetes disponíveis.', maxParticipants:6,  participants:[{i:'A',c:'av-pink',name:'Alice'}], isOpen:true },
  { id:'sr-5', title:'Futebol Itaim',          sport:'⚽', sportSlug:'futebol',  gradient:'linear-gradient(135deg,#22C55E,#166534)', ageRange:'25-35 anos', datetime:'2026-04-30T07:00', duration:'1h30',  local:'Clube Itaim',              address:'R. Joaquim Floriano, 400',       region:'Itaim',    period:'manhã', createdBy:'Diego',   creatorInitial:'D', creatorColor:'av-teal',   description:'Pelada semanal. Vaga aberta para goleiros. Times de 11.',     maxParticipants:22, participants:[{i:'D',c:'av-teal',name:'Diego'},{i:'R',c:'av-purple',name:'Rafael'},{i:'L',c:'av-green',name:'Lucas'}], isOpen:true },
  { id:'sr-6', title:'Corrida Noturna',         sport:'🏃', sportSlug:'corrida',  gradient:'linear-gradient(135deg,#3B82F6,#1D4ED8)', ageRange:'18-40 anos', datetime:'2026-04-28T21:00', duration:'45min', local:'Parque do Povo',           address:'Av. Brig. Faria Lima, s/n',      region:'Itaim',    period:'noite', createdBy:'Ricardo', creatorInitial:'R', creatorColor:'av-blue',   description:'Corrida noturna às luzes da cidade. 3 km, ritmo livre.',      maxParticipants:30, participants:[{i:'R',c:'av-blue',name:'Rodrigo'}], isOpen:true },
  { id:'sr-7', title:'Futebol Lapa',           sport:'⚽', sportSlug:'futebol',  gradient:'linear-gradient(135deg,#22C55E,#15803D)', ageRange:'18-30 anos', datetime:'2026-04-27T20:00', duration:'1h',    local:'Campo Society Lapa',       address:'Rua Cerro Corá, 900',            region:'Lapa',     period:'noite', createdBy:'Paulo',   creatorInitial:'P', creatorColor:'av-orange', description:'Jogo de futebol society aberto. 7×7. Traga chuteira.',       maxParticipants:14, participants:[{i:'P',c:'av-orange',name:'Pedro'},{i:'G',c:'av-green',name:'Gabriel'}], isOpen:true },
  { id:'sr-8', title:'Basquete Moema',         sport:'🏀', sportSlug:'basquete', gradient:'linear-gradient(135deg,#8B5CF6,#6D28D9)', ageRange:'20-35 anos', datetime:'2026-04-28T17:00', duration:'1h30',  local:'Quadra Moema Park',        address:'Av. Moaci, 1000',                region:'Moema',    period:'tarde', createdBy:'Fernanda',creatorInitial:'F', creatorColor:'av-pink',   description:'Pelada de basquete no Moema Park. 5×5.',                      maxParticipants:10, participants:[{i:'F',c:'av-pink',name:'Fernanda'},{i:'M',c:'av-blue',name:'Marina'}], isOpen:true },
];
    ...
    myEvents: [
      {
        ...
        ageRange:'18-35 anos', datetime:'2026-04-30T18:00', duration:'1h30',
...
const Store = {
  ...
  joinEvent(ev) {
    ...
    else { this._s.myEvents.push({ ...ev, status:'active', source: ev.source || 'joined' }); }
    this._s.user.stats.participated = Math.max(this._s.user.stats.participated, this.getMyEvents().length);
    this._save();
  },
  ...
  cancelEvent(id) {
    ...
    if (!ev) return null;
    ev.status = 'cancelled';
    if (ev.source === 'created') this._s.user.stats.created = Math.max(0, this._s.user.stats.created - 1);
    this._s.user.stats.participated = Math.max(0, this._s.user.stats.participated - 1);
    this._save();
    return ev;
  },
